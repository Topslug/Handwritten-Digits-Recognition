...
class TestConvNet_Relu:
    ...
    def __init__(self, input_dim=(1, 28, 28),
                 ...
                 hidden_size=50, output_size=10, initialize='He'):#'He', 'Xavier', 0.01
        # 가중치 초기화===========
        ...
        if initialize == 'He':
            ...
            wight_init_scales = np.sqrt(1.0 / pre_node_nums) # Sigmoid를 사용할 때의 권장 초기값
        else:
            wight_init_scales = initialize * np.ones(pre_node_nums.shape)
...
class TestConvNet_Sigmoid:
    """
    네트워크 구성
        conv - sigmoid - pool - affine - sigmoid - affine - softmax
    """
